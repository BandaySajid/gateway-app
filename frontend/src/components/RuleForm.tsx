				...
				<div>
					...
					<RadioGroup value={filterType} defaultValue={''} onValueChange={setFilterType} className="mt-2 space-y-1">
						<div className="flex items-center space-x-2">
							<RadioGroupItem value="all" id="allRequests" className="cursor-pointer" />
							<Label htmlFor="allRequests" className="cursor-pointer">
								All Requests
							</Label>
						</div>
						<div className="flex items-center space-x-2">
							<RadioGroupItem value="custom" id="customFilter" className="cursor-pointer" />
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					<div className="space-y-2">
						<Label htmlFor="duration">
							Duration (seconds) <Badge variant={'secondary'} className='p-1'>coming soon</Badge> 
						</Label>
						<Input
							disabled
							id="duration"
					...
					<div className="space-y-2">
						...
						<Input id="port" type="number" value={port} min={0} max={65535} onChange={(e) => setPort(e.target.value)} placeholder="Enter port" />
					</div>
				</div>

				<Button variant={'default'} className="cursor-pointer w-full" type="submit" onClick={handleSubmit}>
					Save
				</Button>
			</CardContent>
		</Card>
